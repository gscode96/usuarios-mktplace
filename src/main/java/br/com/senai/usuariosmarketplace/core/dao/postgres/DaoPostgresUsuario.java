...
public class DaoPostgresUsuario implements DaoUsuario {
	...
	public void inserir(Usuario usuario) {
		...
		try {
			...
			throw new RuntimeException("Ocorreu um erro ao inserir o usuario. Motiro: " + e.getMessage());
		} finally {
	...
	public void alterar(Usuario usuario) {
		...
		try {
			...
			throw new RuntimeException("Ocorreu um erro ao alterar o usuario. Motiro: " + e.getMessage());
		} finally {
			ManagerDb.getInstance().fechar(ps);
		}
	}
	...
	public Usuario buscarPor(String login) {
		...
		try {
			...
			throw new RuntimeException("Ocorreu um erro ao selecionar o usuario. Motiro: " + e.getMessage());
		} finally {
			ManagerDb.getInstance().fechar(ps);
